...
public class RegexUtil {
    ...
    public final static boolean isPhone(String text){
        return match(text, "^(1(([35][0-9])|(47)|[8][0126789]))\\d{8}$");
    }
    ...
    public final static boolean isMobile(String text){
        ...
        return match(text, "^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$");
    }
    ...
    private final static boolean match(String text, String reg) {
        if (text.trim().equals("") || reg.trim().equals(""))
            return false;
